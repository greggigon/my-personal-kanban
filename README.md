...
You can get latest release zip [at this link](https://github.com/greggigon/my-personal-kanban/blob/master/my-personal-kanban-0.3.0.zip?raw=true). Lastest version is 0.3.0 and includes new Cloud upload and download functionality.
