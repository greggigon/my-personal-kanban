...
describe("Kanban Repository", function(){
	...
	//TODO: must move this tests to CloudMenu Controller tests or forget about them with the new Sync implementation
	...
	// 	repository.saveDownloadedKanban(encryptedBan, 1391554268110, 'my-random-key');
	// 	var fromStorage = localStorage.getItem('myPersonalKanban');
	...
	// 	var result = repository.saveDownloadedKanban(encryptedBan, 1391554268110, 'dupa');
